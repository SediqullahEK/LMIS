                            ...
                            <div>
                                ...
                                <form wire:submit.prevent="{{ $isEditing ? 'updateStone' : 'addStone' }}"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <input type="text" required wire:model="name" name="name"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="latin_name" name="latin_name"
                                            class="mt-1 px-2 peer block h-10 w-full bg-white border border-slate-300 rounded-md text-sm shadow-sm focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
                                            autocomplete="off" dir="rtl">
                                        @error('latin_name')
                                            <p class="text-red-500">{{ $message }}</p>
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <select required wire:model="quantity"
                                            ...
                                            <option value="0" disabled selected>مقیاس را انتخاب کنید</option>
                                            <option value="gram">گرام</option>
                                            <option value="kilogram">کیلو گرام</option>
                                            <option value="ton">تن</option>
                                            <option value="pound">قیراط</option>
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="estimated_extraction"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="estimated_price_from"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="estimated_price_to"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="offered_royality_by_private_sector"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="final_royality_after_negotiations"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="estimated_revenue_based_on_ORPS"
                                    ...
                                    <span class="col-span-2 text-right">
                                        ...
                                        <span class="text-red-700">*</span>
                                        <input type="text" required wire:model="estimated_revenue_based_on_FRAN"
                                    ...
                                    <div class="">
                                        <span class="w-1/2 text-right ">
                                            ...
                                            <input type="file" wire:model.live="image_path" id="file-upload"
