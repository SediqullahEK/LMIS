...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed top-0 right-0 z-40 w-68 h-full pt-16 transition-transform translate-x-full bg-[#2C3E50] border-l border-gray-200 sm:translate-x-0"
        dir="rtl">
        ...
        <ul class="space-y-2 p-2">
            ...
            <li>
                ...
                <a class="flex items-center p-2 text-white text-sm hover:bg-[#D4AF37] hover:text-gray-900 rounded-lg">
                    ...
                    <p class="mr-3"> جواز های حرفه یی</p>
                </a>
            </li>
            ...
            <li class="group">
                <a href="#"
                    ...
                    <p class="mr-3">جواز های مواد ساختمانی</p>
                </a>
            </li>
            <li class="group">
                <a href="#"
                    ...
                    <p class="mr-3">جواز پروسس برای فابریکه ها</p>
                </a>
            </li>
            <li
    ...
    <!-- Content -->
    <main id="content" class="pt-16 lg:mr-64 transition-all">
        {{ $slot }}
    </main>
